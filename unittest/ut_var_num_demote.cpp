...
template<typename>
struct ut_var_try_demote : public testing::Test {};
...
TYPED_TEST_SUITE(ut_var_try_demote, uint_pairs);

TYPED_TEST(ut_var_try_demote, can_cover_target_max) {
...
TYPED_TEST(ut_var_try_demote, overflow) {
    using source_type = typename TypeParam::first_type;
    using target_type = typename TypeParam::second_type;
...
template<typename>
struct ut_var_try_demote_signed : public testing::Test {};
...
TYPED_TEST_SUITE(ut_var_try_demote_signed, int_pairs);

TYPED_TEST(ut_var_try_demote_signed, can_cover_target_lowest) {
    using source_type = typename TypeParam::first_type;
    using target_type = typename TypeParam::second_type;
...
TYPED_TEST(ut_var_try_demote_signed, underflow) {
    using source_type = typename TypeParam::first_type;
    using target_type = typename TypeParam::second_type;
